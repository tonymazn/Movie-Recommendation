...
e <- evaluationScheme(ratings, method="split", train=train_proportion, k=10, given=15, goodRating=0)
e
```
...
# with matrix factorization by Singular-Value Decomposition (SVD)
 ...
 model_svd <- Recommender(data = getData(e, "known"), method = "SVD")
```
